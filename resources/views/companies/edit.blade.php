    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('companies.update', $company->id) }}">
            ...
            <div>
                ...
                <x-text-input id="nip" class="block mt-1 w-full" type="text" name="nip" value="{{ $company->nip}}" required />
            ...
            <div>
                ...
                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" value="{{ $company->address}}" required />
            ...
            <div>
                ...
                <x-text-input id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" value="{{ $company->postal_code}}" required />
